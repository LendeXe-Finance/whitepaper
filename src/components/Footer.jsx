  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/LendeXeFinance" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink href="https://medium.com/@LendeXeFinance" icon={TelegramIcon}>
          Medium
        </SocialLink>
          <SocialLink href="https://t.me/LendexeFinance" icon={MediumIcon}>
              Medium
          </SocialLink>
        <SocialLink href="https://discord.com/invite/27zhTrWMng" icon={DiscordIcon}>
