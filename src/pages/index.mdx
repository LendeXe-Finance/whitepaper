...
LendeXe is a liquidity ecosystem and so far different types of liquidity streams have been designed for its users. These types are Dynamic Supplying/Borrowing (Lending) in form of preferred collateral and loan, Undercollateralized LendeXe Loan (ULL) in form of LEXE as collateral and XSD as debt.
...
- **10% Lending (borrowers only)**: distributed over 48 months
- **7% Liquidation Pool**: distributed over 48 months
- **7% XSD-Liquidation-Pool**: distributed over 48 months
- **3% Lending lock-drop**: distributed over 12 months
- **1% LendeXe Governance**: distributed over 48 months
...
- **0.28% TGE**
- **0.37%**: distributed over 12 monthly distributions
- **0.47%**: distributed over 12 monthly distributions after 12 months cliff
- **2.76%**: distributed over 24 monthly distributions
- **3.5%**: distributed over 24 monthly distributions after 24 months cliff

### Pre-Seed (6%)

- **1.5% TGE**
- **4.5%**: distributed over 24 monthly distributions after 12 months cliff

### Team and Further Members (15%)

- **12 months cliff + 36 monthly distributions**
